        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="glass-card p-5">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-slate-800">ICOPE 初評</h2>
                            ...
                            <div className="mb-4">
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex-1">
                                            <p className="text-slate-800 font-bold group-hover:text-blue-400 transition-colors">AI 視覺測試 — 椅子起站</p>
                        ...
                        <div className="flex gap-3">
                            <button
                                ...
                                className={`flex-1 py-3 px-4 rounded-xl text-base font-medium transition-all ${!isAbnormal
                                    ...
                                    : 'bg-slate-100 text-slate-500 border-2 border-transparent hover:bg-slate-100'
                                    }`}
                            >
                                ✓ {domain.normalLabel}
                            </button>
                ...
                <div className="glass-card p-5 ring-2 ring-amber-500/30 bg-amber-500/5">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                        {secondaryTasks.map((task) => (
                            <div
                                key={task}
                                className="flex items-center gap-2 p-3 rounded-xl bg-slate-100"
                            >
