...
export default function LoginPage() {
    ...
    useEffect(() => {
        if (!liffReady || !liffLoggedIn || liffAttempted.current) return
        ...
        <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="glass-card p-8 md:p-12 w-full max-w-md relative z-10">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-slate-800 mb-2">CareLoop</h1>
                ...
                {liffReady && !isInLine && (
                    <>
                        ...
                        <button
                            ...
                            disabled={loading || !agreed}
                            className={`w-full flex items-center justify-center gap-3 py-3.5 px-4 rounded-2xl text-white font-bold text-sm transition-all hover:opacity-90 active:scale-[0.98] disabled:cursor-not-allowed ${!agreed ? 'opacity-40' : ''}`}
